...
##  Рекомендация к файлу conftest.py "Нужно исправить: регистрация через пользовательский интерфейс ненадежна и медленна для фикстуры. Для создания тестового пользователя или заранее подготовленного пользователя следует использовать API" Я пока не умею писать автоматизированные тесты с API, эта тема вроде бы будет в 7 спринте. Подскажите пожалуйста, где найти документацию API к сайту https://stellarburgers.education-services.ru/
